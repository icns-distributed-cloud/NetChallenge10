...
//Defalut connect socket handler. Handle defalut packet and recive, process that.
//Cotnrol Connet, Disconnet, Login.
    ...
    public class PKHCommon : PKHandler
    {
        ...
        public void RequestLogin(ServerPacketData packetData)
        {
            ...
            try
            {
                ...
                var errorCode = UserMgr.AddUser(reqData.UserID, packetData.SessionID, packetData.SessionIndex,reqData.LectureID);
